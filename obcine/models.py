...
class Municipality(Timestampable):
    ...
    name_in_rodilnik = models.TextField(verbose_name=_("Ime občine v rodilniku"))
...
class YearlyRevenue(Revenue):
    document = models.ForeignKey(
        "YearlyRevenueDocument", on_delete=models.CASCADE, related_name="children"
    )


class MonthlyRevenue(Revenue):
    document = models.ForeignKey(
        "MonthlyRevenueDocument", on_delete=models.CASCADE, related_name="children"
    )
...
class YearlyExpense(Expense):
    document = models.ForeignKey(
        "YearlyExpenseDocument", on_delete=models.CASCADE, related_name="children"
    )
...
class MonthlyExpense(Expense):
    document = models.ForeignKey(
        "MonthlyExpenseDocument", on_delete=models.CASCADE, related_name="children"
    )
