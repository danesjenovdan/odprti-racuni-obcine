...
DATABASE_NAME="odprti_racuni_obcine"
K8S_NAMESPACE="odprti-racuni-obcine"
SECRETS_NAME="odprti-racuni-obcine-credentials"
...
# docker container exec -i $(docker compose ps -q db) psql -U odprti_racuni_obcine odprti_racuni_obcine < db.dump
